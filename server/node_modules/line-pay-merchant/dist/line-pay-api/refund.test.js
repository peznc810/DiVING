...
describe('refund', () => {
    ...
    it('should call httpClient.post', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        (0, refund_1.refundWithClient)(httpClient)(req);
        expect(httpClient.post).toHaveBeenCalledWith(`/v3/payments/${transactionId}/refund`, body, {
            timeout: 20000
        });
    ...
    it('should throw exception if transactionId does not exist in request config', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            yield (0, refund_1.refundWithClient)(mockHttpClient)(req);
        }
        catch (e) {
...
//# sourceMappingURL=refund.test.js.map