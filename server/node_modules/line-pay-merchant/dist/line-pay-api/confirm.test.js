...
describe('confirm', () => {
    ...
    it('should call httpClient.post', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        (0, confirm_1.confirmWithClient)(httpClient)(req);
        expect(httpClient.post).toHaveBeenCalledWith(`/v3/payments/${transactionId}/confirm`, body, {
            timeout: 40000
        });
    ...
    it('should throw exception if transactionId does not exist in request config', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            yield (0, confirm_1.confirmWithClient)(mockHttpClient)(req);
        }
        catch (e) {
