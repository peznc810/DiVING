...
export default function Test() {
  ...
  const [selectedDisName, setSelectedDisName] = useState('') //區名 用來放標題
  const [mapDistrictData, setMapDistrictData] = useState([]) //單個區的資料
                  ...
                  <g>
                    ...
                    <g className={styles['ctaSvg']}>
                      <g className={styles['same']}>
                        {/* 東沙環礁 */}
                        <circle cx="123.92" cy="517.75" r="15.43"></circle>
                        <path
                      ...
                      <g>
                        {/* 東部海岸 */}
                        <circle cx="398.42" cy="213.5" r="15.43"></circle>
                        <path
                          className={styles['diveSvg']}
                      ...
                      <g>
                        {/* 東北角 */}
                        <circle cx="450.17" cy="48" r="15.43"></circle>
                        <path
                          className={styles['diveSvg']}
                      ...
                      <g>
                        {/* 澎湖*/}
                        <circle cx="91.92" cy="308" r="15.43"></circle>
                        <path
                          className={styles['diveSvg']}
                      ...
                      <g>
                        {/* 墾丁 */}
                        <circle cx="280.17" cy="551.75" r="15.43"></circle>
                        <path
                          className={styles['diveSvg']}
                      ...
                      <g>
                        {/* 綠島 */}
                        <circle cx="372.92" cy="411.5" r="15.43"></circle>
                        <path
                          className={styles['diveSvg']}
                      ...
                      <g>
                        {/* 蘭嶼 */}
                        <circle cx="385.92" cy="507.25" r="15.43"></circle>
                        <path
                          className={styles['diveSvg']}
                      ...
                      <g>
                        {/* 小琉球 */}
                        <circle cx="203.67" cy="497.75" r="15.43"></circle>
                        <path
                          className={styles['diveSvg']}
